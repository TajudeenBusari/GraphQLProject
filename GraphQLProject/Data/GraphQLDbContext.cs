...
/*this class is drived from DbContext (from entity framework core)
 *Acts as bridge between application and database
*1. Create a constructor
*2. inject the DbContextOptions class as argument(takes our class name)
*3. create the DbSet
*4. use OnModelCreating to seed some data into the DB
 */

    ...
    public partial class seedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2024, 5, 17, 22, 6, 17, 179, DateTimeKind.Local).AddTicks(625), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2024, 5, 20, 22, 6, 17, 179, DateTimeKind.Local).AddTicks(674), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2024, 5, 24, 22, 6, 17, 179, DateTimeKind.Local).AddTicks(677), "Celebrating a birthday." }
                });
